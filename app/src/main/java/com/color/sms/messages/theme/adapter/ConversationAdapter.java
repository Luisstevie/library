...
import com.color.sms.messages.theme.base.SmallNativeAdsViewHolder;
...
public class ConversationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        if (i != -1) {
            ...
            view = inflater.inflate(R.layout.layout_small_native_ads, viewGroup, false);
            return new SmallNativeAdsViewHolder(view);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolderParent, int position) {
        ...
        if (conversation == null) {
            ((SmallNativeAdsViewHolder) viewHolderParent).bind();
        } else {
