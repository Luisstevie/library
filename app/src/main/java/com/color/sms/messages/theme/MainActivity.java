...
import com.color.sms.messages.theme.base.BaseAdsActivity;
...
import com.color.sms.messages.theme.theme.activity.SmsThemeActivity;
...
import static com.color.sms.messages.theme.base.BaseActivity.REQUEST_PERMISSION_SMS;

public class MainActivity extends BaseAdsActivity implements LoaderManager.LoaderCallbacks<Cursor>,
    ...
    private void initView() {
        ...
        binding.lnCompose.setOnClickListener(v -> startActivityForResult(new Intent(MainActivity.this, NewMessageActivity.class), REQUEST_GET_CONTACT));
...
//            startActivity(getIntent());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.group_message:
                ...
                break;
            case R.id.sms_theme:
                startActivity(new Intent(this, SmsThemeActivity.class));
                break;
            case R.id.search:
    ...
    public Loader<Cursor> onCreateLoader(int id, @Nullable Bundle args) {
        ...
        binding.lnCompose.setVisibility(View.GONE);
    ...
    public void onLoadFinished(@NonNull Loader<Cursor> loader, Cursor cursor) {
        try {
            if (loader.getId() == 0) {
                ...
                binding.lnCompose.setVisibility(View.VISIBLE);
